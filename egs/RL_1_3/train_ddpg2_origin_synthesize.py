...
if __name__ == "__main__":
    ...
    model2 = CustomDDPG(
        ...
        tensorboard_log=f'./spolacq_tmplog_synthesize_{features_dim}/',
        policy_kwargs=dict(
            net_arch=dict(
    ...
    model2.learn(
        ...
        eval_log_path=f"./logs_reproduce_{features_dim}/",
        )
    
    env.save_rewards(f"./spolacq_tmplog_synthesize_{features_dim}/rl_accuracy.npy")
