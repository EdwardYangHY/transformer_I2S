...
config["u2u"]["path1"] = "/net/papilio/storage2/yhaoyuan/transformer_I2S/saved_model/U2U/transformer_vit1/transformer_vit1.pt"
...
if __name__ == "__main__":
    ...
    model2.learn(
        ...
        eval_log_path="./logs_ddpg_without_embed_icassp/",
        )
    
    eval_env.save_rewards("./logs_ddpg_without_embed_icassp/", data_name=datetime.datetime.now().strftime('%y%m%d%H%M')+"_ddpg")