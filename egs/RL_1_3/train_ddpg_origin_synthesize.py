...
sentence_encoder.load_state_dict(torch.load("../../saved_model/U2U/transformer_cnn1_synthesize.pt"))
...
if __name__ == "__main__":
    ...
    if is_debug:
        img_train_list = img_train_list[:10]
        img_eval_list = img_eval_list[:1]
    ...
    model2 = CustomDDPG(
        ...
        tensorboard_log=f'./spolacq_tmplog_synthesize_{features_dim}_no_sentence/',
        # policy_kwargs=dict(
        #     net_arch=dict(
    ...
    model2.learn(
        ...
        eval_log_path=f"./logs_reproduce_{features_dim}_no_sentence/",
        )
    
    env.save_rewards(f"./spolacq_tmplog_synthesize_{features_dim}_no_sentence/rl_accuracy.npy")