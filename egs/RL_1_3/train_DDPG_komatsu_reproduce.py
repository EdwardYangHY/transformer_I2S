...
def main(save_name, spoken_backbone, word_map_path = None):
    ...
    ### U2S model trained on synthesized speech, ResDAVEnetVQ
    tts_model_path = "../../saved_model/U2S/outdir_komatsu_ResDAVEnetVQ_22050/checkpoint_26000"
    tacotron_model = load_tacotron2(model_path=tts_model_path, max_decoder_step = 500, sr = 22050, vocab_size = 1024)
    ...
    model_path = "../../saved_model/I2U/Komatsu_4_captions_all_224/Codec_reproduce"
    # model_path = spoken_backbone
    # if is_debug:
    #     model_path = "../../saved_model/I2U/komatsu_4_captions_256_hubert/Codec_baseline_BLEU_12_7*7_no_tune"

    word_map_path = "../../data/processed/Komatsu_4_captions_all_224/WORDMAP_coco_4_cap_per_img_1_min_word_freq.json"
