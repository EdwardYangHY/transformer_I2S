...
# I2U
# In this script we use all the same word map
...
checkpoint_path = "../../saved_model/I2U/VC_5_captions_224/fixed_img_1024_no_sentence/"
...
def i2u2s2t(action):
    ...
    seq = model.decode(word_map['<start>'], word_map['<end>'], action=action, max_len=130, beam_size=5)
...
if __name__ == "__main__":
    ...
    model2 = CustomDDPG(
        ...
        tensorboard_log='./spolacq_tmplog_new_fixed_image_no_sentence/',
        # policy_kwargs=dict(
        #     net_arch=dict(
    ...
    model2.learn(
        ...
        eval_log_path="./logs_ddpg_new_fixed_image_no_sentence/",
        )
    
    env.save_rewards("./spolacq_tmplog_new_fixed_image_no_sentence/rl_accuracy.npy")