...
if __name__ == "__main__":
    ...
    model2 = CustomDDPG(
        ...
        tensorboard_log='./spolacq_tmplog_hard_img_no_sentence/',
        # policy_kwargs=dict(
        #     net_arch=dict(
    ...
    model2.learn(
        ...
        eval_log_path="./logs_ddpg_hard_img_no_sentence/",
        )
    
    env.save_rewards("./spolacq_tmplog_hard_img_no_sentence/rl_accuracy.npy")