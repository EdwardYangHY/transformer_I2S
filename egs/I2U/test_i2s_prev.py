...
def evaluate(model_path, word_map_path):
    ...
    #     model_path = "../../saved_model/I2U/VC_5_captions/no_uLM_no_sen_refine_global_transform"
    ...
    for split in ["VAL", "TEST"]:
        ...
        with open(model_path + f"/{split}_recognition_results_{image_resolution}.txt", "w") as f:
...
def main():
    ...
    model_paths = ["../../saved_model/I2U/VC_5_captions_256/23-03-23_15:32:07_uLM_sentence"]
    word_map_paths = ["../../data/processed/VC_5_captions_256/WORDMAP_coco_5_cap_per_img_1_min_word_freq.json"]
