...
def main():
    ...
    # model = TransformerConditionedLM(
    ...
    #     image_backbone = model_params["image_backbone"],
    #     fine_tune_image_encoder = model_params["fine_tune_image_encoder"],
    #     use_refine_encoder = model_params["use_refine_encoder"],
    #     use_global_feature = model_params["use_global_feature"],
    #     AR = model_params["AR"]
    # )
